...
\titleformat{\part}[display]
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=center, inner sep=0pt, text width=0.84\paperwidth, align=center] at (current page.center) {%
      \fontsize{28}{34}\selectfont\headingfontfamily\color{fg}\currentparttitle%
    };
  \end{tikzpicture}%
  \phantom}
