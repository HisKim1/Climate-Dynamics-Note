...
\renewcommand{\@pnumwidth}{2.5em} % Widen the page-number column (default 1.55em)
...
\newgeometry{left=0cm,right=1cm} % No left margin, reduced right margin
...
\ifnum \c@tocdepth >\m@ne
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{bgalt}{\vtop{\hsize=\dimexpr\textwidth-2.5cm\relax
      \hspace*{2.5cm}\strut\color{fg}\bfseries\sffamily\uppercase{#1}
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
\fi}
...
\ifnum \c@tocdepth >\z@
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{bg}{\vtop{\hsize=\dimexpr\textwidth-2.5cm\relax
      \hspace*{2.5cm}\strut\color{fg}\sffamily#1
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
\fi}
