\newcommand{\coverpage}[5]{
    ...
    %%%%%%%%%%%%%%%%%%%% Title + Subtitle %%%%%%%%%%%%%%%%%%%%
    \drawtext{\Huge\textbf{#1}\\\Large{\hangulfontfamily #2}}{$(current page.center)+(3.2,-3.2)$}{6cm}{-60}{text=fg,align=right,font=\headingfontfamily};

    %%%%%%%%%%%%%%%%%%%% Author Name %%%%%%%%%%%%%%%%%%%%
    \begin{pgfonlayer}{fg}
    \drawtext{\Large #3\\\Large #4}{$(current page.east)+(-0.5,-5.2)$}{4cm}{0}{text=fg,anchor=east,align=right,font=\headingfontfamily};
    \end{pgfonlayer}
