...
\titlespacing*{\section}{0pt}{1.2ex plus .3ex minus .08ex}{.35ex plus .05ex}
\titlespacing*{\subsection}{0pt}{1.0ex plus .25ex minus .08ex}{.25ex plus .05ex}
\titlespacing*{\subsubsection}{0pt}{.65ex plus .2ex minus .05ex}{.15ex plus .03ex}
...
\titleformat{\section}
  {\normalfont\large\headingfontfamily\bfseries\selectfont\color{accent}}
  {\numberinmargin{\thesection}{16}{accent}}
  {0pt}
  {\MakeUppercase}

\titleformat{\subsection}
  {\normalfont\normalsize\headingfontfamily\bfseries\selectfont\color{accent}}
  {\numberinmargin{\thesubsection}{12}{accent}}
  {0pt}
  {}

\titleformat{\subsubsection}
  {\normalfont\small\headingfontfamily\bfseries\selectfont\color{accent}}
  {\numberinmargin{\thesubsubsection}{10}{accent}}
  {0pt}
  {}
