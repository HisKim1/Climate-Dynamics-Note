...
\begin{remark}[Key features at 850\,hPa]\tight
\begin{itemize}
...
\begin{remark}[Key features at 500\,hPa]\tight
\begin{itemize}
...
\begin{remark}[Key features at 200\,hPa]\tight
\begin{itemize}
...
\begin{definition}[Major Pressure Centres]\tight
...
\begin{remark}[Zonal-mean zonal wind structure]\tight
\begin{itemize}
...
\begin{remark}[Eddy geopotential height]\tight
\begin{itemize}
...
\begin{example}[Thermal wind estimate of the subtropical jet]\tight
...
\begin{definition}[Hadley Cell --- Annual Mean]\tight
...
\begin{remark}[Seasonal SLP contrast]\tight
\begin{multicols}{2}
...
\begin{remark}[Somali Jet and monsoon onset]\tight
...
\begin{remark}[Seasonal jet asymmetry]\tight
...
\begin{definition}[Tropopause structure]\tight
...
\begin{definition}[Quasi-Biennial Oscillation (QBO)]\tight
...
\begin{remark}[ITCZ migration]\tight
...
\begin{definition}[Major Precipitation Features]\tight
\begin{itemize}
...
\begin{remark}[Precipitation--vertical motion linkage]\tight
...
\begin{remark}[Seasonal precipitation patterns]\tight
\begin{multicols}{2}
\textgr{JJA:}
\begin{itemize}
...
\begin{remark}[Diabatic heating: latent heat vs.\ radiative cooling]\tight
...
\begin{definition}[Key SST Features]\tight
\begin{itemize}
...
\begin{remark}[SST--precipitation relationship]\tight
...
\begin{remark}[SST--wind coupling]\tight
