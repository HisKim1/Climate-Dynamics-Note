...
\begin{remark}
  ...
  \textgr{Key observation:} $\overline{u}_Z\,\overline{v}_Z \approx 0$인데,
  이는 mass-balance constraint \eqref{eq:vz-integral}에 의해
  $\overline{v}_Z$가 연직 방향에서 부호가 바뀌기 때문이다.
  $\overline{u}_Z$와의 곱은 적분 시 대부분 상쇄된다.
\end{remark}
