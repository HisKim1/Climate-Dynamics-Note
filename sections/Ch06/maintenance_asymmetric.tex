...
\begin{figure}[htbp]
  ...
  \caption{Time-mean poleward eddy momentum flux $\overline{u'v'}$
    at 300\,hPa for DJF (four-panel by season/component).
    Positive values ($\overline{u'v'} > 0$) indicate \emph{poleward}
    ...
    \hisu{상층 momentum flux $\overline{u'v'}>0$: storm track 출구 부근에서 최대 poleward westerly 수송.
          여기가 곧 jet stream을 유지하는 핵심 영역.}}
  \label{fig:ch06_sw_momflux}
\end{figure}

$\overline{u'v'} > 0$는 westerly momentum의 \emph{poleward transport}를 뜻한다.
