...
\begin{definition}[Zonal-Mean and Eddy Decomposition]\tight
...
\begin{proposition}[Vanishing of Zonal Derivatives]\tight
...
\begin{remark}[Mean-Flow Contribution is Negligible]\tight
...
\begin{theorem}[Steady-State Heat Balance]\tight
...
\begin{theorem}[Steady-State Momentum Balance]\tight
...
\begin{proposition}[Phase Condition for Nonzero Heat Flux]\tight
...
\begin{proposition}[Phase Condition for Nonzero Momentum Flux]\tight
...
\begin{definition}[QG Potential Vorticity]\tight
...
\begin{proposition}[Vorticity Flux Identity]\tight
...
\begin{proposition}[Thickness Flux Identity]\tight
...
\begin{theorem}[Resolution of the Upgradient Momentum Puzzle]\tight
...
\begin{theorem}[Non-Acceleration Theorem (Charney and Drazin, 1961)]\tight
...
\begin{definition}[Eliassen--Palm Flux]\tight
...
\begin{theorem}[Non-Acceleration in EP Flux Form]\tight
...
\begin{remark}[Interpretation of EP Flux Diagrams]\tight
...
\begin{remark}[The Ferrel Cell]\tight
...
\begin{definition}[Residual Circulation]\tight
...
\begin{definition}[Net Radiation at TOA]\tight
